...
function StudentCard({ student, onDelete }) {
  return (
    <div className="bg-white border border-gray-200 rounded-md p-4 hover:shadow-md transition duration-200">
      <div className="flex justify-between items-start">
        ...
        <div className="flex space-x-2">
          <Link
            ...
            className="px-3 py-1 bg-green-100 text-green-600 rounded-md hover:bg-green-200 transition duration-200 flex items-center"
            title="View"
          >
